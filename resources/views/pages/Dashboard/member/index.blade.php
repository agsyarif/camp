                                ...
                                <tr class="text-gray-700">
                                    <td class="w-1/2 px-1 py-2">
                                        <div class="flex items-center text-sm">
                                            ...
                                            <div>
                                                <p class="font-medium text-black">Khalil Asy'ari</p>
                                                <p class="text-sm text-gray-400">09 May 2021</p>
                                            </div>
                                ...
                                <tr class="text-gray-700">
                                    <td class="w-1/2 px-1 py-2">
                                        <div class="flex items-center text-sm">
                                            ...
                                            <div>
                                                <p class="font-medium text-black">Muhammad Rifki</p>
                                                <p class="text-sm text-gray-400">28 December 2021</p>
                                ...
                                <tr class="text-gray-700">
                                    <td class="w-1/2 px-1 py-2">
                                        <div class="flex items-center text-sm">
                                            ...
                                            <div>
                                                <p class="font-medium text-black">Khairul Ikhwan</p>
                                                <p class="text-sm text-gray-400">01 Agustus 2021</p>
                                            </div>
